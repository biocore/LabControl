...
DB_CREATE_TEST_TABLE = """CREATE TABLE labcontrol.test_table (
    str_column      varchar DEFAULT 'foo' NOT NULL,
    bool_column     bool DEFAULT True NOT NULL,
    int_column      bigint NOT NULL);"""

DB_DROP_TEST_TABLE = """DROP TABLE IF EXISTS labcontrol.test_table;"""
...
class TestBase(TestCase):
    ...
    def _populate_test_table(self):
        ...
        sql = """INSERT INTO labcontrol.test_table
...
class TestConnHandler(TestBase):
    ...
    def test_sql_executor_no_sql_args(self):
        sql = "INSERT INTO labcontrol.test_table (int_column) VALUES (1)"
    ...
    def test_sql_executor_with_sql_args(self):
        sql = "INSERT INTO labcontrol.test_table (int_column) VALUES (%s)"
    ...
    def test_execute_fetchall_with_sql_args(self):
        self._populate_test_table()
        sql = "SELECT * FROM labcontrol.test_table WHERE bool_column = %s"
...
class TestTransaction(TestBase):
    ...
    def test_execute(self):
        with TRN:
            ...
            sql = """UPDATE labcontrol.test_table
    ...
    def test_execute_return(self):
        with TRN:
            ...
            TRN.add(sql, ['test_insert', 2])
            sql = """UPDATE labcontrol.test_table SET bool_column = %s
    ...
    def test_execute_huge_transaction(self):
        with TRN:
            ...
            sql = """INSERT INTO labcontrol.table_to_make (the_trans_to_fail)
                     VALUES (1)"""
            TRN.add(sql)
    ...
    def test_context_manager_rollback(self):
        try:
            with TRN:
                sql = ("INSERT INTO labcontrol.test_table "
                       "(str_column, int_column) VALUES (%s, %s) "
                       "RETURNING str_column, int_column")
                args = [['insert1', 1], ['insert2', 2], ['insert3', 3]]
                TRN.add(sql, args, many=True)
    ...
    def test_context_manager_multiple(self):
        ...
        with TRN:
            ...
            with TRN:
                ...
                sql = ("INSERT INTO labcontrol.test_table "
                       "(str_column, int_column) VALUES "
                       "(%s, %s) RETURNING str_column, int_column")
                args = [['insert1', 1], ['insert2', 2], ['insert3', 3]]
                TRN.add(sql, args, many=True)
