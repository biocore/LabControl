...
ALTER TABLE labcontrol.sequencing_process ADD COLUMN assay_type_id INTEGER;
ALTER TABLE labcontrol.sequencing_process ADD CONSTRAINT fk_assay_type FOREIGN KEY (assay_type_id) REFERENCES labcontrol.assay_type(assay_type_id);
