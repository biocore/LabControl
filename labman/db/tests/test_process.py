...
class TestSequencingProcess(LabmanTestCase):
    ...
    # Ok, the Knight lab doesn't test private methods.  But I do :) AEB
    # def test__generate_sample_proj_value(self):
    #     expected_value = "LabDude_PIDude_1"
    #     real_value = SequencingProcess._generate_sample_proj_value('1.SKB4.640189')
